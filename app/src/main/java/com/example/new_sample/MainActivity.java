        ...
        b_equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    ACTION = EQU;
                    if (!ifReallyDecimal()) {
                        t1.setText(/*t2.getText().toString() + String.valueOf(val2) + "=" + */String.valueOf(val1));
                    } else {
                        t1.setText(/*t2.getText().toString() + String.valueOf(val2) + "=" + */String.valueOf((int) val1));
                    }
                    t1.setText(null);
                } else {
                    t2.setText("Error");
    ...
    private void operation() {
        if (!Double.isNaN(val1)) {
            ...
            switch (ACTION) {
                case ADDITION:
                    val1 = val1 + val2;
                    Log.d(operation, "addition success");
                    break;
                case SUBTRACTION:
                    val1 = val1 - val2;
                    Log.d(operation, "subtraction success");
                    break;
                case MULTIPLICATION:
                    val1 = val1 * val2;
                    Log.d(operation, "multiplication success");
                    break;
                case DIVISION:
                    val1 = val1 / val2;
                    Log.d(operation, "division success");
                    break;
                case EXTRA:
                    val1 = (-1) * val1;
                    Log.d(operation, "multiplication success");
                ...
                case MODULUS:
                    val1 = val1 % val2;
                    Log.d(operation, "modulo success");
                    break;
                case EQU:
                    Log.d(operation, "equal success");
                    break;
            }
        } else {
            val1 = Double.parseDouble(t1.getText().toString());
